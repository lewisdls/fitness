...
export const Footer = () => {
  return (
    <div>
        <div className="bg-neutral-900 text-white grid grid-cols-4 justify-center w-full h-full p-30">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-y-4 gap-x-8 w-fit">
      ...
      <div className="space-y-6">
        ...
        <p className="leading-loose">
          Subscribe our Newsletter and gates latest updates of offers, products
          and promotions from every week we provide
        </p>
